...
app
  ...
  .post((req: Request, res: Response) => {
    ...
    const message = {
      ...
      subject:
        "Email from " + contactInfo.email + " about " + contactInfo.subject, // Subject line
...
app.post("/quickSearch", (req: Request, res: Response) => {
  ...
  if (!tempVal) {
    console.log(
      "The input has more than a single word and/or contains symbols."
    );
    res.render("failure", {
      data:
        "Your input is not valid. Please try again withput symbols and special characters",
    });
    return false;
  }
